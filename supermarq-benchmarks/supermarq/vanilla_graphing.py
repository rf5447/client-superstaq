...
# --- 1. LOAD DATA ---
# Ensure this matches the CSV generated by your vanilla scoring run
output_csv = "vanilla_benchmark_results.csv" 
...
ax1.set_title('SupermarQ Vanilla QAOA', fontsize=16, fontweight='bold')
...
print("Saved: vanilla_performance_line.png")
...
ax2.set_title("QAOA Method: Vanilla", fontsize=15, fontweight='bold', pad=20)
