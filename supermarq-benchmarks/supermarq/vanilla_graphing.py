...
# --- 1. LOAD DATA ---
output_csv = "benchmark_results_combined/vanilla_qaoa_benchmark_results_combined.csv"
...
plt.tight_layout()
plt.savefig("vanilla_bar_charts.png", dpi=300, bbox_inches='tight')
print("Saved: vanilla_bar_charts.png")
...
plt.tight_layout()
plt.savefig("vanilla_bar_charts_no_torino.png", dpi=300, bbox_inches='tight')
print("Saved: vanilla_bar_charts_no_torino.png")
