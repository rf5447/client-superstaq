...
# Keep original VQEProxy sizes and extend through Forte-1's 36-qubit limit.
QUBIT_COUNTS = [4, 7, 9, 11, 25, 36]
N_LAYERS = [1, 2, 3, 4, 5]
        ...
        for nl in N_LAYERS:
            ...
            for idx, circ in enumerate(circuits):
                ...
                try:
                    ...
                    # IonQ hardware needs measurements to return shot-based counts.
                    ...
                    filename = (
                        outdir
                        / f"vqeproxy_q{nq}_l{nl}_{basis_label}_forte.json"
                    )
