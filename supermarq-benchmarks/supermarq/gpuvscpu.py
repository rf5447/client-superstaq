...
# cpu_file = "ghz_timing_results_includingwarmup_p0.csv"
# gpu_file = "ghz_timing_results_cudaq_includingwarmup.csv"
...
#         ax.set_title(f"{platform} {pretty_name}")
#         ax.set_xticks(x)
...
# fig.suptitle(
#     "CPU and GPU Run Time Comparison of GHZ Benchmark", # \nMean over 3 runs; error bars show std. dev. of each sub-time
#     fontsize=18,
#     y=0.98
# )

# plt.tight_layout(rect=[0, 0, 1, 0.90])
# plt.savefig("ghz_timing_2x4_subplots_includingwarmuprun.png", dpi=300)
# plt.show()
...
cpu_file = "ghz_timing_results_includingwarmup_ordered.csv"
gpu_file = "ghz_timing_results_cudaq_includingwarmup_ordered.csv"
...
plt.tight_layout(rect=[0, 0, 1, 0.90])
plt.savefig("ghz_timing_2x4_subplots_includingwarmuprun_ordered.png", dpi=300)
plt.show()