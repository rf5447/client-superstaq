...
# --- 1. CONFIGURATION ---
input_directory = "ibmk/mb_ibmk"
output_csv = "benchmark_resultsk/mb_benchmark_results.csv"
headers = ["benchmark", "n_qubits", "backend", "shots", "score", "job_id", "timestamp"]

new_rows = []

# --- 2. DATA PROCESSING ---
print("Starting processing of all files in directory...")
...
if new_rows:
    ...
    print(f"\nNo new data was added. Check if files exist in {input_directory}/.")
