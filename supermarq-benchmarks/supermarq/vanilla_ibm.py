...
os.makedirs("vanilla_ibm", exist_ok=True)
...
for nq in [4, 5, 7, 11, 12, 13, 16]:#, 20]:
    # Vanilla QAOA Proxy returns a single circuit
...
for backend_name in backend_names:
    ...
    for i, pub_result in enumerate(result):
        ...
        # Filename updated to reflect vanilla_ibm directory and nq
        filename = f"vanilla_ibm/vanilla_q{m['nq']}_{backend_name}.json"
